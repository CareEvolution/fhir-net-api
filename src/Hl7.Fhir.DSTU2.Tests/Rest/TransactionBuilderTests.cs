...
namespace Hl7.Fhir.Test
{
    ...
    public class TransactionBuilderTests
    {
        ...
        public void TestUrlEncoding()
        {
            ...
            var req = b.Entry[0].ToHttpRequestMessage(DSTU2ModelInfo.Instance, endpoint, null, Prefer.ReturnRepresentation, ResourceFormat.Json, useFormatParameter: true, CompressRequestBody: false);
