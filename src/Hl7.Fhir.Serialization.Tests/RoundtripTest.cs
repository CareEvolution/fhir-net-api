    ...
    public class RoundtripTest
    {
        ...
        private static void convertResourcePoco(string inputFile, string outputFile)
        {
            ...
            if (inputFile.EndsWith(".xml"))
            {
                ...
                var resource = new FhirXmlParser(DSTU2ModelInfo.Instance, new ParserSettings { PermissiveParsing = true }).Parse<Resource>(xml);
            ...
            else
            {
                ...
                var resource = new FhirJsonParser(DSTU2ModelInfo.Instance, new ParserSettings { PermissiveParsing = true }).Parse<Resource>(json);
