...
namespace Hl7.Fhir.Tests.Validation
{
    ...
    public class ValidationTests
    {
        ...
        public void TestIdValidation()
        {
            ...
            Fhir.Validation.DotNetAttributeValidation.Validate(id);
            Fhir.Validation.DotNetAttributeValidation.Validate(id, true);        // recursive checking shouldnt matter
        ...
        public void IdIsNowAString()
        {
            ...
            Fhir.Validation.DotNetAttributeValidation.Validate(hn);
        }
        ...
        private void validateErrorOrFail(object instance, bool recurse = false, string membername = null)
        {
            ...
            {
                // should throw error
                Fhir.Validation.DotNetAttributeValidation.Validate(instance, recurse);
                Assert.Fail();
            }
        ...
        public void OIDandUUIDUrls()
        {
            ...
            System.ComponentModel.DataAnnotations.Validator.ValidateObject(uri, new ValidationContext(uri), true);
        ...
        public void TestAllowedChoices()
        {
            ...
            Fhir.Validation.DotNetAttributeValidation.Validate(p);
        ...
        public void TestCardinality()
        {
            ...
            Fhir.Validation.DotNetAttributeValidation.Validate(oo, true);
        }
        ...
        public void ContainedResourcesAreValidatedToo()
        {
            ...
            Fhir.Validation.DotNetAttributeValidation.Validate(pr);
        }
        ...
        public void TestContainedConstraints()
        {
            ...
            patn.Contained = null;
            Fhir.Validation.DotNetAttributeValidation.Validate(pat);
        ...
        public void ValidateResourceWithIncorrectChildElement()
        {
            ...
            // Now, it should work
            Fhir.Validation.DotNetAttributeValidation.Validate(enc);
            Fhir.Validation.DotNetAttributeValidation.Validate(enc, true);  // recursive checking shouldnt matter
        ...
        public void TestXhtmlValidation()
        {
            ...
            Fhir.Validation.DotNetAttributeValidation.Validate(p, true);
