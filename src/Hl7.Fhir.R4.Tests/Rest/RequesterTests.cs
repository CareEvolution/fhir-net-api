...
namespace Hl7.Fhir.Test
{
    ...
    public class RequesterTests
    {
        ...
        public void TestPreferSettingHttpRequester()
        {
            ...
            var request = b.Entry[0].ToHttpRequestMessage(endpoint, SearchParameterHandling.Lenient, Prefer.ReturnMinimal, ResourceFormat.Json, false, false);
            Assert.AreEqual("return=minimal", request.Headers.GetValues("Prefer").FirstOrDefault());

            request = b.Entry[0].ToHttpRequestMessage(endpoint, SearchParameterHandling.Strict, Prefer.ReturnRepresentation, ResourceFormat.Json, false, false);
            Assert.AreEqual("return=representation", request.Headers.GetValues("Prefer").FirstOrDefault());

            request = b.Entry[0].ToHttpRequestMessage(endpoint, SearchParameterHandling.Strict, Prefer.OperationOutcome, ResourceFormat.Json, false, false);
            Assert.AreEqual("return=OperationOutcome", request.Headers.GetValues("Prefer").FirstOrDefault());

            request = b.Entry[0].ToHttpRequestMessage(endpoint, SearchParameterHandling.Strict, null, ResourceFormat.Json, false, false);
            ...
            request = b.Entry[0].ToHttpRequestMessage(endpoint, SearchParameterHandling.Lenient, Prefer.ReturnMinimal, ResourceFormat.Json, false, false);
            ...
            request = b.Entry[0].ToHttpRequestMessage(endpoint, null, Prefer.ReturnRepresentation, ResourceFormat.Json, false, false);
