...
namespace Hl7.Fhir.Tests.Rest
{
    ...
    public class FhirClientTests
    {
        ...
        [TestMethod]   // Something does not work with the gzip
        ...
        public void TestAuthenticationOnBeforeWebClient()
        {
            ...
            using (FhirClient validationFhirClient = new FhirClient("https://sqlonfhir.azurewebsites.net/fhir", messageHandler: handler))
            {
                ...
                {
                    e.RawRequest.Headers.Authorization = new AuthenticationHeaderValue("Bearer", "bad-bearer");
                };
                try
                {
        ...
        public void TestCreatingBinaryResource()
        {
            ...
            using (FhirClient client = new FhirClient(testEndpoint, messageHandler: handler))
            {
                ...
                handler.OnBeforeRequest += Client_OnBeforeRequest;
        ...
        public void TestOperationEverything()
        {
            ...
            {
                validationFhirClient.RequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", "bad-bearer");
