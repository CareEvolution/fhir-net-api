...
namespace Hl7.Fhir.Serialization
{
    public class BaseFhirParser
    {
        ...
        public BaseFhirParser(Model.Version version)
        {
            Settings = new ParserSettings(version);
        }
        ...
        public Base Parse(ISourceNode node, Type type=null) => node.ToPoco(buildPocoBuilderSettings(Settings), type);
