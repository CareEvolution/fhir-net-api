...
namespace Hl7.Fhir.Serialization
{
    ...
    internal class ComplexTypeReader
    {
        ...
        public ComplexTypeReader(IModelInfo modelInfo, ITypedElement reader, ParserSettings settings)
        {
            _current = reader;
        ...
        internal Base Deserialize(Base existing = null)
        {
            ...
            var mapping = _modelInfo.FindClassMappingByType(_current.InstanceType);
        ...
        private void read(ClassMapping mapping, IEnumerable<ITypedElement> members, Base existing)
        {
            foreach (var memberData in members)
            {
                ...
                if (mappedProperty != null)
                {
                    ...
                    var reader = new DispatchingReader(_modelInfo, memberData, Settings, arrayMode: false);
