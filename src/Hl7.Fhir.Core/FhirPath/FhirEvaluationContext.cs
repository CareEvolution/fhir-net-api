...
namespace Hl7.Fhir.FhirPath
{
    public class FhirEvaluationContext : EvaluationContext
    {
        ...
        public FhirEvaluationContext(Model.Version version, Resource resource) : base(resource?.ToTypedElement(version))
        {
        }
        ...
        [Obsolete("Please use CreateDefault() instead of this member, which may cause race conditions. Obsolete since 2018-10-17")]
