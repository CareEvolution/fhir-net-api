...
namespace Hl7.Fhir.Serialization
{
    ...
    public class JsonNavigatorStream : INavigatorStream
    {
        ...
        /// <summary>Returns a new <see cref="ITypedElement"/> instance positioned on the current entry.</summary>
        public ITypedElement Current
        {
            get
            {
                ...
                return jelem != null ? FhirJsonNode.Create(jelem).ToTypedElement() : null;
            }
        }
