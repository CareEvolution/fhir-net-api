...
namespace Hl7.Fhir.Rest.DSTU2
{
    public partial class FhirClient : IDisposable, IFhirClient<Resource,Bundle,Conformance>
    {
        ...
        public Task<Resource> WholeSystemOperationAsync(string operationName, IParameters parameters = null, bool useGet = false)
        {
        ...
        public Resource WholeSystemOperation(string operationName, IParameters parameters = null, bool useGet = false)
        {
            return WholeSystemOperationAsync(operationName, parameters, useGet).WaitResult();
        }


        public Task<Resource> TypeOperationAsync<TResource>(string operationName, IParameters parameters = null, bool useGet = false)
            where TResource : Resource
        {
            if (operationName == null) throw Error.ArgumentNull(nameof(operationName));
        ...
        public Resource TypeOperation<TResource>(string operationName, IParameters parameters = null,
        ...
        public Task<Resource> TypeOperationAsync(string operationName, string typeName, IParameters parameters = null, bool useGet = false)
        {
            if (operationName == null) throw Error.ArgumentNull(nameof(operationName));
        ...
        public Resource TypeOperation(string operationName, string typeName, IParameters parameters = null, bool useGet = false)
        {
        ...
        public Task<Resource> InstanceOperationAsync(Uri location, string operationName, IParameters parameters = null, bool useGet = false)
        {
            if (location == null) throw Error.ArgumentNull(nameof(location));
            if (operationName == null) throw Error.ArgumentNull(nameof(operationName));
        ...
        public Resource InstanceOperation(Uri location, string operationName, IParameters parameters = null, bool useGet = false)
        {
        ...
        public Task<Resource> OperationAsync(Uri location, string operationName, IParameters parameters = null, bool useGet = false)
        {
            if (location == null) throw Error.ArgumentNull(nameof(location));
            if (operationName == null) throw Error.ArgumentNull(nameof(operationName));
        ...
        public Resource Operation(Uri location, string operationName, IParameters parameters = null, bool useGet = false)
        {
            return OperationAsync(location, operationName, parameters, useGet).WaitResult();
        }


        public Task<Resource> OperationAsync(Uri operation, IParameters parameters = null, bool useGet = false)
        {
        ...
        public Resource Operation(Uri operation, IParameters parameters = null, bool useGet = false)
        {
        ...
        private Task<Resource> internalOperationAsync(string operationName, string type = null, string id = null, string vid = null,
            IParameters parameters = null, bool useGet = false)
        {
        ...
        private async Task<TResource> executeAsync<TResource>(Bundle tx, IEnumerable<HttpStatusCode> expect) where TResource : Resource
        {
                ...
                && new ResourceIdentity(response.Response.Location).IsRestResourceIdentity()) // Check that it isn't an operation too
            {
                ...
                result = response.Resource as Resource;
        ...
        class RequesterDSTU2 : Requester
        {
            ...
            protected override IResource CreateOperationOutcomeForException(Exception exception)
            {
