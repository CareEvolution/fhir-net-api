            ...
            get
            {
                ...
                else
                {
                    ...
                    if (IsCollection)
                    {
                        ...
                        if (FhirValue is ICustomCollectionPath customCollectionPath)
                        {
                            var path = customCollectionPath.GetCollectionPath();
                            if (!string.IsNullOrEmpty(path)) return $"{_parentCommonPath}.{cur.Name}{path}";
                        }
